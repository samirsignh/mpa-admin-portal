            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Edit Internation Arbitartion Details</h4>
                        <a href="{{ route('arbitrationList') }}" id="user_add_btn"
                    ...
                    <div class="card-body">
                        <form action="{{ route('updateArbitration') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9 mt-3">
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="iac_document" id="iac_document"
                                                class="form-control" placeholder="upload file" required>
                                        </div>
                                    </div>
                                    <div class="col-md-3 mt-5">
                                        @if (File::exists(public_path($details->iac_document)))
                                        <a class="sarod_file" href="{{ asset($details->iac_document) }}" download>
